...
#include "NVIC_PRIV.h"
/**
 * @def 	PriorityGrouping_POSITION
 * @brief 	used in shifting offset value to be corresponding for offset bits in Regsiter
 */
#define PriorityGrouping_POSITION 0x08
/**
 * @def 	PASSWORD_MASK
...
#define OFFSET_MASK  0x03FFFFE00
/**
 * @def 	RESET_MASK
 * @brief 	Base Address of Flash
 */
...
/**
 * @def     Peripheral
 * @brief   Numbers asssigned to peripherals is the offset of them in vector table array
 *
 */
#define WWDG				0
#define PVD					1
 ...
 * @param   IRQn Variable of u8 , Interrupt Request Number is number assigned to peripheral as it is offset of them in vector table array ex (WWDG , TIM2)
 * @return  OK | NOT_OK
 */
...
/**
 * @brief   Function to change vector Table offset
 * @param   offset Variable of u32 , Change vector Table offset
 * @return  NA
 */
